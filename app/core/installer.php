	...
	public  function install(){
		...
		$create = array(
			...
			"CREATE TABLE  IF NOT EXISTS `mvne_events` (
				...
				`venue_id` INT NULL,
				`allow_group_registration` TINYINT NOT NULL DEFAULT 0, 
				`max_group_registrants` TINYINT NULL ,
				`maillist` VARCHAR(45) NULL,
				`closed` TINYINT NOT NULL DEFAULT 0,
				`attendee_limit` TINYINT NULL,
				`gallery_images` VARCHAR(256) NULL,
				`posts_content` VARCHAR(256) NULL,
